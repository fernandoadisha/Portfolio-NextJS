...
const Navbar = () => {
    ...
    return (
        ...
        <>
            ...
            z-50 ${isScroll ? "bg-[#fff] bg-opacity-50 backdrop-blur-lg shadow-sm" : ""}`}>
                <a href="#top">
                ...
                <div className='flex item-center gap-4'>
                    ...
                    <button className='block md:hidden ml-3' onClick={openMenu}>
                        <Image src={assets.menu_black} alt='menuIcon' className='w-6' />
                    </button>
                ...
                top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500'>
                    <div className='absolute right-6 top-6'>
                        <Image src={assets.close_black} alt='closeblack' className='w-5 cursor-pointer' onClick={closeMenu} />
                    </div>
